...
fig, ax = plt.subplots()
ax.plot(x, y_est, '-', label=r'$E_{add}$ $r^2=0.80271$')
...
ax.plot(x, y_est, '-', label=r'$E_{net}$ $r^2=0.84918$')
ax.fill_between(x, y_est - y_err, y_est + y_err, alpha=0.1)
...
ax.plot(x, y_est, '-', label=r'$E_{eff}$ $r^2=0.74133$')
ax.fill_between(x, y_est - y_err, y_est + y_err, alpha=0.1)
...
ax.plot(x, y_est, '-', label=r'$T$ $r^2=0.83922$')
ax.fill_between(x, y_est - y_err, y_est + y_err, alpha=0.1)
ax.plot(x, y, '.', color='m')
...
ax.plot(x, y_est, '-', label=r'$DI$ $r^2=0.68261$')
ax.fill_between(x, y_est - y_err, y_est + y_err, alpha=0.1)
